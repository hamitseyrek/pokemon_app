...
class Pokedex {
  ...
  Map<String, dynamic> toJson() => {
        "pokemon": pokemon == null
            ? null
            : new List<dynamic>.from(pokemon!.map((x) => x.toJson())),
      };
}
...
class Pokemon {
  ...
  factory Pokemon.fromJson(Map<String, dynamic> json) => new Pokemon(
        ...
        type: json["type"] == null
            ? null
            : new List<String>.from(json["type"].map((x) => x)),
        ...
        weaknesses: json["weaknesses"] == null
            ? null
            : new List<String>.from(json["weaknesses"].map((x) => x)),
        nextEvolution: json["next_evolution"] == null
            ? null
            : new List<Evolution>.from(
  ...
  Map<String, dynamic> toJson() => {
        ...
        "type":
            type == null ? null : new List<dynamic>.from(type!.map((x) => x)),
        ...
        "multipliers": multipliers == null
            ? null
            : new List<dynamic>.from(multipliers!.map((x) => x)),
        "weaknesses": weaknesses == null
            ? null
            : new List<dynamic>.from(weaknesses!.map((x) => x)),
        "next_evolution": nextEvolution == null
            ? null
            : new List<dynamic>.from(nextEvolution!.map((x) => x.toJson())),
        "prev_evolution": prevEvolution == null
            ? null
            : new List<dynamic>.from(prevEvolution!.map((x) => x.toJson())),
      };
}
